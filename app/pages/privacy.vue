<template>
    <div class="container mx-auto p-8">
        ...
        <section class="mb-8">
            ...
            <p class="mb-2">
                Welcome to Resumate. This Privacy Policy explains how we collect, use, disclose, and safeguard your
                information when you visit our website resumate.munees.co.in, including any other media form, media
            ...
            <p>
                ...
                encouraged to periodically review this Privacy Policy to stay informed of updates. You will be deemed to
                have been made aware of, will be subject to, and will be deemed to have accepted the changes in any
                revised Privacy Policy by your continued use of the Site after the date such revised Privacy Policy is
                posted.
            </p>
        </section>
        ...
        <section class="mb-8">
            ...
            <p class="mb-2">
                ...
                chat, posting messages in comment sections or in our forums, liking posts, sending feedback, and
                responding to surveys.
            </p>
            <h3 class="text-xl font-medium mb-2">Derivative Data</h3>
            <p class="mb-2">
            ...
            <h3 class="text-xl font-medium mb-2">Financial Data</h3>
            <p class="mb-2">
                Financial information, such as data related to your payment method (e.g., valid credit card number, card
                brand, expiration date) that we may collect if you purchase, order, return, exchange, or request
                information about our services from the Site. We store only very limited, if any, financial information
                that we collect. Otherwise, all financial information is stored by our payment processor, [Payment
                Processor Name], and you are encouraged to review their privacy policy and contact them directly for
        ...
        <section class="mb-8">
            <h2 class="text-2xl font-semibold mb-4">4. Disclosure of Your Information</h2>
            <p class="mb-2">
                We may share information we have collected about you in certain situations. Your information may be
                disclosed as follows:
            </p>
            <h3 class="text-xl font-medium mb-2">By Law or to Protect Rights</h3>
            <p class="mb-2">
            ...
            <h3 class="text-xl font-medium mb-2">Third-Party Service Providers</h3>
            <p class="mb-2">
        ...
        <p class="text-sm text-gray-600 mt-8">Last updated: May 21, 2024</p>
    </div>
</template>
...
<style scoped>
/* Add any specific styles for your privacy page here */
</style>
