<template>
    <div class="container mx-auto p-8">
        ...
        <section class="mb-8">
            ...
            <p class="mb-2">
                The Site and its original content, features, and functionality are owned by Resumate and are protected by international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
            </p>
        </section>
        ...
        <section class="mb-8">
            ...
            <p class="mb-2">
                In no event shall Resumate, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.
            </p>
        </section>
...
<style scoped>
/* Add any specific styles for your terms page here */
</style>
